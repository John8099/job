...
<body>
    ...
    <div class="min">
        ...
        <table id='myTable'>
            ...
            <tbody>
                <?php
                $q = $con->query("SELECT * FROM users u LEFT JOIN category c ON u.expertise = c.cat_id WHERE u.usertype ='applicant' and hiredby IS NULL");
                $count = 1;
                ...
                ?>
                    <tr class="tr">
                        ...
                        <td>
                            <?php
                            $getRatings = $con->query("SELECT * FROM employment WHERE `user_id`=$res->id");
